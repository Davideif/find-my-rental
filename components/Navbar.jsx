        ...
        <div className='relative flex h-20 items-center justify-between'>
          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <Link className='flex flex-shrink-0 items-center' href='/'>
              <Image className='h-10 w-auto' src={logo} alt='FindMyRental' />
...
=======
  ...
  {isMobileMenuOpen && (<div  id="mobile-menu">
    <div className="space-y-1 px-2 pb-3 pt-2">
      ...
      {!isLoggedIn && ( <button className="flex items-center text-white bg-gray-700 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 my-5">
        <FaGoogle  className="text-white mr-2"/>
        <span>Login or Register</span>
      </button>)}
